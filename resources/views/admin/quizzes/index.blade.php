            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head" style="align-items: center;">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Quizzes</h3>
                    </div>
                    <a href="{{ route('admin.quizzes.create') }}" class="btn btn-outline-primary">
                                    ...
                                    <td nowrap>
                                        <span class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{ route('admin.quizzes.edit', $d->id) }}">Edit</a>
                                                <form method="post" action="{{ route('admin.quizzes.destroy', $d->id) }}">
                                                    @csrf
                                                    @method('DELETE')
